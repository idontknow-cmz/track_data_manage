<template>
  ...
  >
    <a-form :model="formData" :rules="rules" ref="formRef">
      <a-form-item label="页面名称" prop="name" required>
        <a-input v-model="formData.name" placeholder="请输入页面名称" allow-clear />
      </a-form-item>
      <a-form-item label="关联应用" prop="appid" required>
        <a-input
      ...
      <a-form-item label="页面描述" prop="description">
        <a-textarea
          placeholder="请输入页面描述"
